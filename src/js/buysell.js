...
function submitOrder(op) {
    require(["js/Constants"], function(Constants) {
        ...
        if (!qtyN || !name) {
            ...
            var mex= op + "|" + Constants.PORTFOLIO_ID + "|" + name + "|" + qtyN;
            ...
            var msg= _portfolioQueueSession.createTextMessage(mex);
            producer.send(msg);
        }
    });
}
